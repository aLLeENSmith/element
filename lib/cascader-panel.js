...
/* harmony default export */ var cascader_nodevue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    isDisableSelect: function isDisableSelect() {
  ...
  methods: {
    ...
    renderRadio: function renderRadio(h) {
      var checkedValue = this.checkedValue,
          value = this.value,
          isDisabled = this.isDisabled,
          isDisableSelect = this.isDisableSelect;
...
var node_Node = function () {
  ...
  _createClass(Node, [{
    ...
    get: function get() {
      ...
      var disableSelectKey = config.disableSelect;
      var checkStrictly = config.checkStrictly;

      return data[disableSelectKey] || !checkStrictly && parent && parent.isDisabled;
    }
  }, {
    key: 'isLeaf',
    get: function get() {
